    ...
    <div className="flex flex-col md:flex-row lg:mt-20 ml-20 mt-60">
      <div className="md:w-1/2 md:ml-20">
        ...
        <div className="mt-10 item-center">
          <h1 className="text-gray-500 text-2xl">Plan : Aadhaar Shila (944)</h1>
          <h1 className="text-gray-500 font-bold mt-2">Product Summary:</h1>
          <p className="">
            Aadhar Shila is a regular premium, non - liked, with profit
            Endowment Assurance plan. Exclusively designed for female lives.
            This plan is available with out medical examination and is provided
            only for standard lives. Maximum sum assured on a single life is
          ...
          <p>
            Sum Assured OR 7 times of Annualized Premium, OR 110% of all
