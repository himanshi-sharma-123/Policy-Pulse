    ...
    <div className="flex flex-col md:flex-row lg:mt-20 ml-20 mt-60">
      <div className="md:w-1/2 md:ml-20">
        ...
        <div className="mt-10 item-center">
          <h1 className="text-gray-500 text-2xl">Plan : Jeevan Anand (915)</h1>
          <h1 className="text-gray-500 font-bold mt-2">Product Summary:</h1>
          <p className="">
            Jeevan Anand Plan (915) is a regular premium, non - linked, with
            profit Endowment Assurance plan with life long insurance coverage
            equal to basic sum assured of the plan.{" "}
          </p>
          ...
          <p>
            125% of Sum Assured + Vested Bonus + Final Addition Bonus(FAB) if
            any, OR 7 times of Annualized Premium, OR 105% of all premiums paid
            as on death, WHICH EVER IS HIGHER.
          </p>
...
export default JeevanAnand;
// PLAN FEATURES
// Jeevan Anand Plan (915)

// Product Summary: Jeevan Anand Plan (915) is a regular premium, non - liked, with profit Endowment Assurance plan with life long insurance coverage equal to basic sum assured of the plan.
...
// Maximum Age at Entry: 50 year (Nearest birth day)
...
// On Death: 125% of Sum Assured + Vested Bonus + Final Addition Bonus(FAB) if any, OR 7 times of Annualized Premium, OR  105% of all premiums paid as on death, WHICH EVER IS HIGHER.
