      ...
      <div className="md:w-1/2 md:ml-20">
        ...
        <div className="mt-10 item-center">
          <h1 className="text-gray-500 text-2xl">
            Plan : Single Premium Endowment (917)
          </h1>
          ...
          <p>Sum Assured + Vested Bonus + Final Addition Bonus(if any). </p>
...
export default SinglePremiumEndownment;
